...
#[derive(Serialize, Deserialize, bincode_reloaded::Encode, bincode_reloaded::Decode)]
...
fn test_serde_round_trip() {
    ...
    // validate bincode_reloaded working
    let bytes = bincode_reloaded::serde::encode_to_vec(
        SerdeRoundtrip {
            a: 15,
            b: 15,
            c: TupleS(2.0, 3.0, 4.0),
